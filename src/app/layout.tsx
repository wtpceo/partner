...
export const metadata: Metadata = {
  title: "위즈더플래닝 x SH인터내셔날 | 프리미엄 콘텐츠 제작",
  description: "음식점과 브랜드를 위한 전문 콘텐츠 제작 서비스. 사진 촬영, SNS 영상, 인플루언서 먹방, 유튜브 채널 운영까지. SH인터내셔날 제휴 30% 할인 혜택.",
  metadataBase: new URL("https://sh-psi-kohl.vercel.app"),
  openGraph: {
    title: "프리미엄 콘텐츠 제작",
    description: "여기를 눌러 링크를 확인하세요.",
    url: "https://sh-psi-kohl.vercel.app",
    siteName: "위즈더플래닝 x SH인터내셔날",
    images: [
      {
